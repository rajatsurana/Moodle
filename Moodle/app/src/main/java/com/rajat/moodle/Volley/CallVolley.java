...
public class CallVolley {
       ...
       // static Map<String, String> myHeaders;
        ...
        //
        public static void listAllCourseAssignmentCall(String url, final Context context)
        {
                pDialog=  Tools.showProgressBar(context);
                ...
                StringRequest request = new StringRequest(Request.Method.GET, url, new Response.Listener<String>()
                {
                        ...
                        public void onResponse(String response)
                        {
                                ...
                                {
                                        Log.i("rajat", " onResponseActive " + response);
                                        listAllCourseAssignmentApiJsonParser(response, context);
                                        pDialog.dismiss();
                                }
                                catch (Exception localException)
                                {
        ...
        //
        public static void viewCourseGradesCall(String url, final Context context)
        {
                pDialog=  Tools.showProgressBar(context);
                ...
                StringRequest request = new StringRequest(Request.Method.GET, url, new Response.Listener<String>()
                {
                        ...
                        public void onResponse(String response)
                        {
                                ...
                                {
                                        Log.i("rajat", " onResponseActive " + response);
                                        viewCourseGradesApiJsonParser(response, context);
                                        pDialog.dismiss();
                                }
                                catch (Exception localException)
                                {
        ...
        //
        public static void viewCourseThreadsCall(String url, final Context context)
        {
                pDialog=  Tools.showProgressBar(context);
                ...
                StringRequest request = new StringRequest(Request.Method.GET, url, new Response.Listener<String>()
                {
                        ...
                        public void onResponse(String response)
                        {
                                ...
                                {
                                        Log.i("rajat", " onResponseActive " + response);
                                        viewCourseThreadsApiJsonParser(response, context);
                                        pDialog.dismiss();
                                }
                                catch (Exception localException)
                                {
        ...
        //
        public static void viewParticularThreadCall(String url, final Context context)
        {
                pDialog=  Tools.showProgressBar(context);
                ...
                StringRequest request = new StringRequest(Request.Method.GET, url, new Response.Listener<String>()
                {
                        ...
                        public void onResponse(String response)
                        {
                                ...
                                {
                                        Log.i("rajat", " onResponseActive " + response);
                                        viewParticularThreadApiJsonParser(response, context);
                                        pDialog.dismiss();
                                }
                                catch (Exception localException)
                                {
...
//createNewThreadCall
public static void createNewThreadCall(String url, final Context context)
{
        pDialog=  Tools.showProgressBar(context);
        ...
        StringRequest request = new StringRequest(Request.Method.GET, url, new Response.Listener<String>()
        {
                ...
                public void onResponse(String response)
                {
                        ...
                        {
                                Log.i("rajat", " onResponseActive " + response);
                                createNewThreadApiJsonParser(response, context);
                                pDialog.dismiss();
                        }
                        catch (Exception localException)
                        {
        ...
        //
        public static void postNewCommentCall(String url, final Context context)
        {
                pDialog=  Tools.showProgressBar(context);
                ...
                StringRequest request = new StringRequest(Request.Method.GET, url, new Response.Listener<String>()
                {
                        ...
                        public void onResponse(String response)
                        {
                                ...
                                {
                                        Log.i("rajat", " onResponseActive " + response);
                                        postNewCommentApiJsonParser(response, context);
                                        pDialog.dismiss();
                                }
                                catch (Exception localException)
                                {
