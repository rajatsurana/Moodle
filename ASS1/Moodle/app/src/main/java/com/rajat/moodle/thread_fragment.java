...
public class thread_fragment extends Fragment implements AbsListView.OnItemClickListener{
    ...
    static ArrayList<CourseThreadObject> values=new ArrayList<CourseThreadObject>();
...
FloatingActionButton fab;
  ...
  */
    ...
    public void AddThreadDialog(final Context context)
    {
        ...
        alert.setTitle("Wanna Start a new Thread");
        ...
        alert.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                try{
                    thread_title= URLEncoder.encode(thread_title, "UTF-8");
                    thread_desc=URLEncoder.encode(thread_desc,"UTF-8");
                   // VolleyClick.postNewComment(values.get(0).thread_id,comment_desc,getActivity());
                }catch (Exception e){
                    Log.i("rajat", "URL encoder: " + e.getLocalizedMessage());
                }
                if (!thread_title.equals("") && !thread_desc.equals("")) {
                    VolleyClick.createNewThread(thread_title, thread_desc, VolleyClick.cou_code, getActivity());
    ...
    public static void goTodepth2(){
        Bundle b=new Bundle();
        b.putString("course_code",VolleyClick.cou_code);
        b.putString("course_description",VolleyClick.course_desc);
        details_fragment fragment = new details_fragment();
        fragment.setArguments(b);

        android.support.v4.app.FragmentTransaction fragmentTransaction =
                ((FragmentActivity)After_login.context).getSupportFragmentManager().beginTransaction();
