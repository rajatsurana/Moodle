...
import com.rajat.moodle.Tools.notification_adapter;
 ...
 */
public class notification_fragment extends Fragment implements AbsListView.OnItemClickListener{
    private OnFragmentInteractionListener mListener;
    ArrayList<NotificationObject> values;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        values = bundle.getParcelableArrayList("notifications");
        View view = inflater.inflate(R.layout.fragment_grade_fragment, container, false);
        After_login.List_id=1;
        After_login.Part=true;
        // Set the adapter
        //  values = bundle.getParcelableArrayList("grade");
        mAdapter = new notification_adapter(getActivity(),
                R.layout.layout_notification, values);
  ...
  */
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
       // VolleyClick.viewParticularThread(values.get(position).id,VolleyClick.object,getActivity());
        if (null != mListener) {
